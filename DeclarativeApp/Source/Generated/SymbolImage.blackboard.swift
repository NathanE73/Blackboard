...
public extension Image {
    ...
    static var symbolABookClosed: Image {
        Image(symbol: .aBookClosed)
    }
    ...
    static var symbolCaseFill: Image {
        Image(symbol: .caseFill)
    }

    @available(iOS 14.2, *)
    static var symbolCharacterBookClosed: Image {
        Image(symbol: .characterBookClosed)
    }
    ...
    static var symbolDieFace1: Image {
        Image(symbol: .dieFace1)
    }

    @available(iOS 14.0, *)
    static var symbolDieFace4: Image {
        Image(symbol: .dieFace4)
    }

    @available(iOS 14.2, *)
    static var symbolInfinityCircleFill: Image {
        Image(symbol: .infinityCircleFill)
    }
    ...
    static var symbolNumber14SquareFill: Image {
        Image(symbol: .number14SquareFill)
    }
...
public extension Label where Title == Text, Icon == Image {
    ...
    init(_ title: some StringProtocol, symbol symbolAsset: SymbolAsset) {
